...
RegisterCommand("10-13", function()
	ESX.TriggerServerCallback('stasiak_10-13:checkjob', function(ils1)
		if ils1 == true then
				local Officer = {}
				...
				TriggerServerEvent("stasiak_10-13:request", Officer)
		else
...
RegisterNetEvent("stasiak_10-13:alert")
AddEventHandler("stasiak_10-13:alert", function(source, Officer)
	if ESX.GetPlayerData().job.name == 'police' then
		PlaySoundFrontend(-1, "HACKING_CLICK_GOOD", 0, 1)
		TriggerEvent('chatMessage', '^*^7[UWAGA]:', {255, 0, 0}, "^810-13 ^7- Poszkodowany Funkcjonariusz | ^3na ulicy ^7" .. Officer.Location)
		Citizen.CreateThread(function()
